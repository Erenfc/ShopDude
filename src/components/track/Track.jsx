      ...
      <section>
        <div className="container mx-auto px-5 md:py-5">
          <div className="flex flex-wrap -m-4 text-center">
            ...
            <div className="p-4 md:w-1/3 sm:w-full w-full">
              <div
              ...
              >
                ...
                <p className="leading-relaxed">Our delivery partner will be at your door.</p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-full w-full">
              ...
              >
                ...
                <p className="leading-relaxed">Get your order delivered in 20-30 minutes.</p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-full w-full">
              ...
              >
                ...
                <p className="leading-relaxed">Enjoy free shipping on orders over 100rs.</p>
              </div>
            </div>
          </div>
        </div>
