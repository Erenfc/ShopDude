            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap">
                    {filteredProducts.slice(0, 8).map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`store-product-container cursor-pointer w-1/2 lg:w-1/5 md:h-120 ${mode === 'light' ? 'bg-white' : 'bg-gray-900'} border-solid border border-gray-300 box-border h-80 shadow-none border-[#f1edf3] p-5 mb-5`}>
