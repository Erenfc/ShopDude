            ...
            <div className="container mx-auto">
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-1 md:justify-center mb-10 ">
                            <Tab>
                                    ...
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        <thead className="text-xs border border-gray-600 text-black uppercase bg-gray-200 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                            <tr>
                                                ...
                                                <th className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                    regularPrice
                                                </th>
                                                <th scope="col" className="px-6 py-3">
                                                    Category
                                        ...
                                        {product.map((item, index) => {
                                            const { title, price, regularPrice, imageUrl, category, brand, date } = item;
                                            return (
                                                <tbody key={index}>
                        ...
                        <TabPanel>
                            <div className="relative overflow-x-auto mb-10">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    {user.map((item, index) => {
                                        const { name, uid, email, mobile, time } = item;
                                        const joinedDate = new Date(time.seconds * 1000);
                                        return (
